...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/dotnet/sdk:4.5-alpine AS build

COPY . /source

WORKDIR /source/WpfApplication1
...
FROM mcr.microsoft.com/dotnet/aspnet:4.5-alpine AS final
WORKDIR /app
...
ENTRYPOINT ["dotnet", "WpfApplication1.dll"]
